    ...
    switch(choice)
    {
		case 1:
		{
            ...
            { 
            	...
            	{ 
                	left_process--; 
                	printf("P%d\t|\t%d\t|\t%d\t|\t%d\t|\t%d\t|\t%d\n",counter+1,arrival_time[counter],burst_time[counter],total_time,total_time-arrival_time[counter],total_time-arrival_time[counter]-burst_time[counter]); 
       	...
       	case 2:
       	{
            ...
            printf("\nProcess Name|Arrival Time|Burst Time\t|Priority\t|Completion Time|Turn Around Time|Waiting Time");
            for(total_time = process_queue[0].arrival_time; total_time < burst_time;)
            {
                ...
                printf("\n%d\t\t%d\t\t%d\t\t%d\t\t%d\t\t%d\t\t%d", largest+1, process_queue[largest].arrival_time, process_queue[largest].burst_time, process_queue[largest].priority,process_queue[largest].current_time,process_queue[largest].turnaround_time, process_queue[largest].wait_time,process_queue[largest].current_time);
            }
